...
@section('container')
    <div class="w-screen h-auto flex flex-col items-center pt-20 pb-8 mt-10">
        <div class="bg-white h-auto w-[50vw] rounded-3xl">
            <div class="w-full h-24 flex justify-between items-center">
                <div class="w-72 h-full flex items-center">
                    <div class="w-20 h-20 rounded-full mx-5"><img src="{{ asset('assets/image/yopi2.jpg') }}" alt="yopi"
        ...
        <div class="bg-white h-auto w-[50vw] rounded-3xl mt-10">
            <div class="w-full h-24 flex justify-between items-center">
                <div class="w-72 h-full flex items-center">
                    <div class="w-20 h-20 rounded-full mx-5"><img src="{{ asset('assets/image/kuro.jpg') }}" alt="yopi"
                            class="rounded-full"></div>
                    <div class="flex flex-col">
                        <p class="text-xl font-semibold">Kurohiko</p>
            ...
            <div class="w-11/12 mx-auto mt-2">
                <p class="text-md font-serif text-justify">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Reprehenderit beatae quos voluptatem suscipit ea, eum ipsum sed necessitatibus enim aperiam placeat non a? Quidem quisquam vero adipisci aliquid ratione veritatis porro, quasi quaerat sunt ex optio unde corrupti minima, accusantium asperiores sint consequuntur vel pariatur quae, ipsa similique veniam cupiditate.</p>
            </div>
            <div class="w-11/12 mx-auto h-[60%] bg-blue-200 flex border-y border-gray-400">
                <img src="{{ asset('assets/image/towa.jpg') }}" alt="post" class="w-1/2 h-full">
                <img src="{{ asset('assets/image/gura.jpg') }}" alt="post" class="w-1/2 h-full">
            </div>
            <div class="w-11/12 mx-auto h-32">
                <div class="w-full h-8 flex flex-col justify-center">
                    <div class="flex items-center pt-24">
                        ...
                        <p class="ml-2">50 Suka</p>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-5 h-5 ml-4">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M2.25 12.76c0 1.6 1.123 2.994 2.707 3.227 1.068.157 2.148.279 3.238.364.466.037.893.281 1.153.671L12 21l2.652-3.978c.26-.39.687-.634 1.153-.67 1.09-.086 2.17-.208 3.238-.365 1.584-.233 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0 0 12 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018Z" />
                        </svg>
                        <p class="ml-2">10 Komentar</p>
                    </div>
                    <div class="flex items-center justify-between pt-5">
                        <div class="flex items-center">
                            <div class="flex mr-12 items-center">
