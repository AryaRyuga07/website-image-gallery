...
@section('container')
    <div>
        <h1 class="text-xl mt-20">Photos</h1>
            ...
            @for ($i = 0; $i < 5; $i++)
                <div class="break-inside-avoid">
                    <div class="darken-brightness break-inside-avoid">
                        <img class="rounded-3xl" src="{{ asset('assets/image/kawaii.jpeg') }}" alt="Programming">
                    </div>
                    <div class="w-auto h-6 p-2 bg-white pb-2 mb-5 rounded-2xl mt-3 flex justify-center text-gray-500">
                        <div class="flex items-center h-2 pb-4">
                            ...
                            <p class="ml-2 text-sm">100 like</p>
                        </div>
                        <div class="flex items-center h-2 pb-4 ml-5">
                            ...
                            <p class="ml-2 text-sm">100 comment</p>
                        </div>
                    </div>
                </div>
            @endfor
